...
bmi_data *bmi_read_data(int window_s, size_t *n_reads) {
    ...
    *n_reads = 0;
    ...
    // Variables para lectura de datos de acelerometro
    ...
    // Variables para lectura de datos de giroscopio
    ...
    bmi_data *data = (bmi_data *)malloc(window_s * sizeof(bmi_data));
    if (data == NULL) {
        printf("Error en la asignacion de memoria para los datos\n");
        exit(EXIT_FAILURE);
    }
    ...
    while (*n_reads < window_s) {
        ...
        if ((tmp & 0b10000000) == 0x80) {
            ...
            bmi_data data_tmp = {acc_x_tmp, acc_y_tmp, acc_z_tmp, gyr_x_tmp, gyr_y_tmp, gyr_z_tmp};
            data[*n_reads] = data_tmp;
            (*n_reads)++;
        }
    }
    return data;
